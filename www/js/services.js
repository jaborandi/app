angular.module("jaborandi.services", [])
// TODO: --|---- directive
...
.directive("runAppEmail", function(){
	return {
			...
			function runApp(event)
			{
				var EmailAddr = $attrs.email || "imprensa@jaborandi.sp.gov.br";
...
.directive("runAppFacebook", function(){
	return {
			...
			function runApp(event)
			{
				var textLink = window.encodeURIComponent($attrs.link) || "https://jaborandi.sp.gov.br";
				if (ionic.Platform.isIOS()){
...
.directive("runOpenUrl", function(){
	return {
			...
			{
				var $href = $attrs.href || "https://jaborandi.sp.gov.br";
